...
{
    public class DecompileMacro
    {
        public static List<string> DecompileCommand(string selectedROMPath, int location, List<int> list, List<int> msg, List<int> movement, bool equ)
        {
            ...
            using (FileStream fs = new FileStream(selectedROMPath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
                ...
                if (equ == false)
                {
                    Result.Add(".equ address, 0x8" + Convert.ToString(string.Format("{0:X6}", location)));
                    Result.Add(".include \"event_macro.asm\"");
                    Result.Add("");
                    equ = true;
                }
                ...
                do
                {
                    ...
                    switch (CommandType)
                    {
                        ...
                        case ".word.call":
                            ...
                            cmdLine += "address + " + address.Replace("0x", "$");
                            ...
                            else
                            {
                                ...
                                subLine += "\n" + string.Join(Environment.NewLine, DecompileCommand(selectedROMPath, sublocation, list, msg, movement, equ));
                            }
